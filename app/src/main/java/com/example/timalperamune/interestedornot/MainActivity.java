...
//    private static List<String> senderTexts = new ArrayList<String>();
    ...
    String keywords ="";
    String emotion ="";
    public static double angerAvg =0.0;
    public static double disgustAvg=0.0;
    public static double fearAvg =0.0;
    public static double joyAvg =0.0;
    public static double sadnessAvg =0.0;
...
//        hiText = (TextView)findViewById(R.id.hi);
